...
public class LoadCommand extends ConfiguredCommand<LookupConfiguration> {
    ...
    protected void run(Bootstrap bootstrap, Namespace namespace, LookupConfiguration configuration) throws Exception {
        ...
        MetadataDoiLookup doiLookup = new MetadataDoiLookup(configuration.getStorage());
        ...
        doiLookup.loadFromFile(inputStreamUnpaidWall, new UnpaidWallReader());
        ...
        DoiIstexIdsLookup istexLookup = new DoiIstexIdsLookup(configuration.getStorage());
